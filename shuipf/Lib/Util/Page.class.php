...
class Page {
    ...
    function __construct($Total_Size = 1, $Page_Size = 20, $Current_Page = 1, $List_Page = 6, $PageParam = 'page', $pageRule = '', $static = FALSE, $static_size = 0) {
        //默认模板配置
        $this->Page_tpl['default'] = array('Tpl' => C("PAGE_TEMPLATE") ? C("PAGE_TEMPLATE") :'{first}{prev}{liststart}{list}{listend}{next}{last}<span class="all">共有{recordcount}条信息</span><span class="pageindex">{pageindex}/{pagecount}</span>', 'Config' => array());
        //每页显示信息数量
