...
class AdminbaseAction extends AppframeAction {
     ...
     * API借口数据查询
     * $parm 参数 array
     * $returnfunction 调用webserver的那个函数方法
     * */
    public function web_soap($parm=array(),$returnfunction)
    {
    	$parm['username']="webservice";//用户名
    	$parm['password']="Mapsal11ca";//密码
    	$client = new SoapClient('http://59.41.59.58:8096/espos_webservice/nv_espos_webservice.asmx?WSDL');
    	$result=$client->getnwincomemaster($parm);
