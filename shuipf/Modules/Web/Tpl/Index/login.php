...
var GV = {
	...
	<style>
		...
		.pop-login-l{display: inline-block; max-width:320px; overflow:hidden;}
		.pop-ct .log-psw-box{position: relative; max-width:320px; overflow:hidden;}
		...
		.pop-ct input[type="text"]{width: 267px;height: 34px;line-height: 34px\0;margin: 0 0 10px 0;padding: 0 0 0 45px;border:1px solid #ccc;font-size: 12px;-ms-box-shadow:inset 1px 1px 3px 1px rgba(0,0,0,.1);-webkit-box-shadow:inset 1px 1px 3px 1px rgba(0,0,0,.1);-moz-box-shadow:inset 1px 1px 3px 1px rgba(0,0,0,.1);box-shadow:inset 1px 1px 3px 1px rgba(0,0,0,.1);}
		...
		.pop-login-r{display: inline-block;width: 205px;text-align: left;vertical-align: top;}
		...
		.pop-login-r .ft-img{background: url('__ROOT__/statics/web/img/login-right-img.png') 0 0 no-repeat;width: 200px;height: 145px;margin:20px 0 0 5px;}
		.pop-login-r .back-img{background: url('{$config_siteurl}statics/web/img/login-back.png') 0 0 no-repeat;width: 220px;height: 220px;}
		.pop-login-r .pop-login-r-wd{font-size: 12px;color: #999;padding-left: 20px;}
...
<body>
    <div class="pop-ct" style="padding: 10px 0 0 10px;">
