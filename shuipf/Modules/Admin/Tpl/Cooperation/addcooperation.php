...
<div class="wrap J_check_wrap">
  <Admintemplate file="Common/Nav"/>
   <form class="J_ajaxForm" action="{:U('Cooperation/addcooperation')}" method="post" id="myform">
   ...
   <table class="table_form contentWrap">
	...
	if ( id =='' || id == undefined ) { 
           ...
           <tr>
            <th width="80">品牌介绍</th>
            <td>
          <input type="test" style="width: 500px;" name="content" value="{$content}" class="input" >
            </td>
          </tr>
   ...
   <div class="btn_wrap">
     ...
     <script>
		function yulanpage()
		{
			...
			$("#yulan2").val($("input[name=content]").val());
			$("#yulan3").val($("textarea[name=news]").val());
    ...
    <input type="hidden" name="discount" id="yulan2" value="">
     <input type="hidden" name="news" id="yulan3" value="">
