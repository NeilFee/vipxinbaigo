    ...
    <div class="table_full">
      <table width="100%">
        ...
        <tr>
          ...
          <th value="" >所属门店</th>
          <td>
            <select name="mendian" disabled="disabled">
            <option value="0" >请选择门店</option>
          <volist name="storelist" id="s">
           <option value="{$s.id}"  <if condition="$data.mendian eq $s['id']">selected="selected" </if> >{$s.name}</option>
            </volist>
           </select>
           <input type='hidden' name="mendian" value="{$data.mendian}">
           </td>
        </tr>
        <tr>
          <th>角色描述</th>
