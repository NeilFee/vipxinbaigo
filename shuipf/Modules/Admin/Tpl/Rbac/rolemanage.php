    ...
    <table width="100%" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <!-- <a href="{:U("Rbac/setting_cat_priv",array("roleid"=>$vo["id"]))}">栏目权限</a> |-->
          <a href="{:U('Management/manager',array('role_id'=>$vo['id']))}">成员管理</a> | <a href="{:U('Rbac/roleedit',array('id'=>$vo['id']))}">修改</a> | <a class="J_ajax_del" href="{:U('Rbac/roledelete',array('id'=>$vo['id']))}">删除</a>
          </if>
          </td>
        </tr>
        </foreach>
