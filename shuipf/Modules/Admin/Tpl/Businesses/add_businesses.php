...
<div class="wrap J_check_wrap">
  ...
  <div class="table_list">
   <form class="J_ajaxForm" action="{:U('Businesses/add_businesses')}" method="post" id="myform">
   ...
   <table class="table_form contentWrap">
	...
	if ( id =='' || id == undefined ) { 
          ...
          <tr>
            ...
            <td><input style="width: 300px;" type="test" name="phone" value="{$name}" class="input" >
              </td>
          </tr>
           <tr>
            <th width="100">商户地址</th>
            <td><input style="width: 300px;" type="test" name="address" value="{$name}" class="input" >
              </td>
          </tr>
...
function chengshiajax(id)
{
  $('#thecity').html('');
   ...
   <div class="btn_wrap">
    ...
    <input type="hidden" name="name_img" id="yulan5" value="">
