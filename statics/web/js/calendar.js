...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\"../statics/web/img/newindex/yprev.gif\">", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\"../statics/web/img/newindex/ynext.gif\">", 1, 2);
	this._nav_ny.width = 25;
	this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\"../statics/web/img/newindex/mprev.gif\">", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\"../statics/web/img/newindex/mnext.gif\">", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
	...
	if (this.isPopup) {
		...
		var td_close = hh("<img id=objclose src=\"../statics/web/img/newindex/close.gif\">", 1, 200);
		td_close.ttip = Calendar._TT["CLOSE"];
		td_close.align = "right";
		//hh("#<div><img src=\"/../statics/web/img/newindex/calendar/close.gif\" onmousedown=\"return;\"></div>", 1, 200).ttip = Calendar._TT["CLOSE"];
	}	
