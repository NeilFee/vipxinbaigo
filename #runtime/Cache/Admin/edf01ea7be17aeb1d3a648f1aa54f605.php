...
<div class="wrap J_check_wrap">
 <div class="nav">
  <ul class="cc">
        <li class="current"><a href="__URL__/index">活动类型管理</a></li>
        
        <li><a href="__URL__/activitiestypeadd">添加活动类型</a></li>
  ...
  <table width="100%" cellspacing="0" >
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td align='center' >
          <a href="<?php echo U("Activitiestype/activitiestypeup",array("id"=>$r['id']));?>">编辑</a> |
          
          
          
          <a class="J_ajax_del" href="<?php echo U("Activitiestype/activitiestypedel",array("id"=>$r['id']));?>">删除</a>
           </td>
