  ...
  <table width="100%" cellspacing="0" >
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
          <td align='center'><?php echo ($r["do_date"]); ?></td>
          ...
          <td align="center"><?php echo ($r["zhiwei"]); ?></td>
           <td align="center"><?php echo ($r["mail"]); ?></td>
          <td align='center' >
           <a class="J_ajax_del" href="<?php echo U("Feedback/del_merchants",array("id"=>$r['id']));?>">删除</a>
           </td>
