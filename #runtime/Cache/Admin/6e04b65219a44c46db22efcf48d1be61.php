  ...
  <table width="100%" cellspacing="0" >
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td align="center"><?php echo ($r["opening_time"]); ?></td>
          <td align="center"><?php echo ($r["measure"]); ?></td>
          <td align='center' >
          <a href="<?php echo U("Store/updatestore",array("id"=>$r['id']));?>">编辑</a> |
          
           <a href="<?php echo U("Store/brand",array("id"=>$r['id']));?>">楼层品牌</a> |
           
           <a class="J_ajax_del" href="<?php echo U("Store/delete",array("id"=>$r['id']));?>">删除</a>
           </td>
