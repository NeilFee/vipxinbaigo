  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10"><?php echo ($User["role_name"]); ?>： <?php echo ($User["username"]); ?></span><a href="<?php echo U('Public/logout');?>" class="mr10">[注销]</a><?php echo tag("view_admin_top_menu");?><a href="<?php echo ($Config["siteurl"]); ?>" class="home" target="_blank">前台首页</a><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
