...
<?php } ?>
   <form class="J_ajaxForm" action="<?php echo U('Newday/addactivities');?>" method="post" id="myform">
        ...
        <tbody>
          <tr>
           ...
           <tr>
            ...
            <td>
	           <select name="atype" >  
		            <?php if(is_array($activitiestypelist)): $i = 0; $__LIST__ = $activitiestypelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value ="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			    </select>  
             </td>
          </tr>
