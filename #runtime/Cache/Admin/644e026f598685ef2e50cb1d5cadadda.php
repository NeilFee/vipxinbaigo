...
<?php } ?>
   <form class="J_ajaxForm" action="<?php echo U('Newday/upnewsday');?>" method="post" id="myform">
         ...
         <tr>
          ...
          <tr>
            ...
            <?php if($single == false): ?><td>[原始门店：
              <?php if(is_array($storelist)): $i = 0; $__LIST__ = $storelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['checkbox'] == 1): ?><input  checked="false" type="checkbox" value="<?php echo ($vo["id"]); ?>" name="mendian[]" />
