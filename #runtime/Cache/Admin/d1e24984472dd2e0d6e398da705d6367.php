   ...
   <div class="h_a">搜索</div>
    ...
    <div class="search_type cc mb10">
      <div class="mb10"> <span class="mr20">
       城市名称：
        <input type="text" class="input length_2" name="name" style="width:200px;" value="<?php echo ($name); ?>" placeholder="请输入城市名称">
  ...
  <table width="100%" cellspacing="0" >
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td align='center' >
          <a href="<?php echo U("City/cityup",array("id"=>$r['id']));?>">编辑</a> |
           <a class="J_ajax_del" href="<?php echo U("City/citydel",array("id"=>$r['id']));?>">删除</a>
           </td>
