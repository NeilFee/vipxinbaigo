...
<script type="text/javascript">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Newday/index');?>">每天一点新</a><span class="clr-ccc"> > </span><a href="<?php echo U("Newday/daynews");?>">最新资讯</a><span class="clr-ccc"> > </span><?php echo ($title); ?>
				</span> 
			</div>
			<div class="detail-ct clearfix">
				<div class="news-dt-l">
					<div class="news-dt-top">
						<div class="news-dt-top-l">
							...
							<h2 style="margin: 5px 0 0 0;line-height:auto">发布日期： <?php echo ($date_time); ?></h2>
						...
						<div id="shouchangkey">
						   <?php if($keyname == 1): ?><div class="news-dt-top-r" id="news-dt-top-r">
									<button class="news-dt-top-r"  onclick="shouchang(<?php echo ($id); ?>,'daynews');"></button>
								</div>
							<?php else: ?>
				...
				<div class="news-dt-r">
					<h2>热门资讯</h2>
					<?php if(is_array($daytuijian)): $i = 0; $__LIST__ = $daytuijian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news-dt-list">
						<a href="__URL__/newsdetail/id/<?php echo ($vo["id"]); ?>"><h3><?php echo ($vo["title"]); ?></h3></a>
