		...
		<div class="detail-main clearfix">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/index');?>">合作伙伴</a><span class="clr-ccc"> > </span>联盟商户
				</span> 
			</div>
			<div class="co-top-tab2">
				<ul>
					<a href="<?php echo U('Cooperation/index');?>"><li>合作品牌</li></a>
					<a href="<?php echo U('Cooperation/merchant');?>"><li class="cur">联盟商户</li></a>
				</ul>
				...
				<div class="tab-section3 clearfix">
					<div class="section-btbd">
						...
						<a <?php if($act == 'a'): ?>class="cur"<?php endif; ?> href="<?php echo U("Cooperation/merchant",array("act"=>'a'));?>">不限</a>
							<?php if(is_array($citylist)): $i = 0; $__LIST__ = $citylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($cityid == $vo['id']): ?>class="cur"<?php endif; ?>  href="<?php echo U("Cooperation/merchant",array("cityid"=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					<div class="sec-section2">
					<?php if($storelistcc != null): ?><div class="sec-section-wd">
							<?php if(is_array($storelistcc)): $i = 0; $__LIST__ = $storelistcc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($mendian == $vo['id']): ?>class="cur"<?php endif; ?> href="__URL__/merchant/storeid/<?php echo ($vo['id']); ?>/cityid/<?php echo ($cityid); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div><?php endif; ?>
					</div>
				...
				<div class="tab-section2 clearfix">
					<span>选择品类：</span>
					<div class="section-wd">
						<a href="<?php echo U('Cooperation/merchant');?>">不限</a>
						<?php if(is_array($businessesnodelist)): $i = 0; $__LIST__ = $businessesnodelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($mid == $vo['id'] ): ?>class="cur"<?php endif; ?> href="__URL__/merchant/mid/<?php echo ($vo['id']); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>
			</div>
			<div class="total-brand">共有 <span class="tt-brnd-num"><?php echo ($count); ?></span> 家联盟商户</div>
			<ul class="merchn-list">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U("Cooperation/mdetail",array("id"=>$vo['id']));?>"><img src="<?php echo ($vo["name_img"]); ?>" alt=""></a>
					<a href="">
			...
			<h1>< 商户推荐 ></h1>
			<?php if(is_array($tuijianlist)): $i = 0; $__LIST__ = $tuijianlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="rec-ct">
					<i class="rec-num-1"></i>
					<div class="rec-each">
						<a href="<?php echo U("Cooperation/mdetail",array("id"=>$vo['id']));?>">
						<img src="<?php echo ($vo["name_img"]); ?>" alt=""></a>
						<div class="rec-mask"></div>
						<p class="rec-wd">
							<a href="<?php echo U("Cooperation/mdetail",array("id"=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
						</p>
					</div>
