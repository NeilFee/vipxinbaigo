...
<script type="text/javascript">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/index');?>">合作伙伴</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/index');?>">合作品牌</a><span class="clr-ccc"> > </span><?php echo ($name); ?>
				</span>
			</div>
			<div class="detail-ct">
				<div class="detail-top">
					...
					<div class="detail-r">
						...
						<div class="detail-panel">
							<?php if($keyname == 1 ): ?><button id="shouchangkey" class="detail-clct-btn" onclick="shouchang(<?php echo ($id); ?>,'cooperation');"></button>
							<?php else: ?>
