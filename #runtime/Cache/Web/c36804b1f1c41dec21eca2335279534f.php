...
<script type="text/javascript">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Newday/index');?>">每天一点新</a>
					<span class="clr-ccc"> > </span><a href="<?php echo U('Newday/index');?>">会员活动</a><span class="clr-ccc"> > </span><?php echo ($title); ?>
				</span>
			</div>
			<div class="detail-ct">
				<div class="detail-top">
					...
					<div class="detail-r">
						...
						<?php if(strtotime($e_date) < time() ): ?><button id="yiguoqikey" class="detail-outdated-btn" onclick=""></button><?php endif; ?>
						<div class="detail-panel">
							
							<?php if($keyname == 1 ): ?><button id="shouchangkey" class="detail-clct-btn" onclick="shouchang(<?php echo ($id); ?>,'activities');"></button>
							<?php else: ?>
				...
				<div class="detail-store">
					...
					<?php  $mendianarray=explode(',',$mendian); ?>
							
					<span style="color: #333">活动支持门店：</span>
					<?php if(is_array($mendianarray)): $i = 0; $__LIST__ = $mendianarray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($storelist)): $i = 0; $__LIST__ = $storelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i; if($co['id'] == $vo): ?><span><a href="__URL__/index/storeid/<?php echo ($co["id"]); ?>/cityid/<?php echo ($chengshi); ?>"><?php echo ($co["name"]); ?></a></span><?php endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
				</div>
