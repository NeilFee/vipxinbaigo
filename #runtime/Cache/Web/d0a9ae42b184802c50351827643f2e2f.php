		...
		<div class="detail-main clearfix">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/index');?>">合作伙伴</a><span class="clr-ccc"> > </span>合作品牌
				</span> 
			</div>
			<div class="co-top-tab">
				<ul>
					<a href="<?php echo U('Cooperation/index');?>"><li class="cur">合作品牌</li></a>
					<a href="<?php echo U('Cooperation/merchant');?>"><li>联盟商户</li></a>
				</ul>
			</div>
			<div class="total-brand">共有 <span class="tt-brnd-num"><?php echo ($count); ?></span> 个品牌</div>
			<ul class="brand-list">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U("Cooperation/detail",array("id"=>$vo['id']));?>"><img src="<?php echo ($vo["img"]); ?>" alt=""></a>
					<div class="brand-list-wds">
						<a href="<?php echo U("Cooperation/detail",array("id"=>$vo['id']));?>"><h3><?php echo ($vo["name"]); ?></h3></a>
						<p class="brand-list-wd-time"><?php echo ($vo["date_time"]); ?> 更新</p>
						<p class="brand-list-wd-intro"><?php echo ($vo["discount"]); ?></p>
					</div>
