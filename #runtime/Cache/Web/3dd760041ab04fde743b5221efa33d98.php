...
<link rel="stylesheet" type="text/css"
	href="<?php echo ($config_siteurl); ?>statics/web/css/admin_style.css" />
...
.pop-ct i.forget-vip-num {
	...
	top: 11px;
	display: inline-block;
	background: url('<?php echo ($config_siteurl); ?>statics/web/img/vip-i20.png') no-repeat 0 -90px;
	width: 15px;
	height: 16px;
}
.pop-ct i.forget-psw {
	...
	top: 6px;
	display: inline-block;
	background: url('<?php echo ($config_siteurl); ?>statics/web/img/vip-i20.png') no-repeat 0 -150px;
	width: 16px;
	height: 25px;
}
.pop-ct i.check-code {
	...
	top: 11px;
	display: inline-block;
	background: url('<?php echo ($config_siteurl); ?>statics/web/img/vip-i20.png') no-repeat 0 -190px;
	width: 25px;
	height: 25px;
	z-index:1000;
}
...
.qrcode-target {
	...
	top: 0;
	right: 0;
	background-image: url('<?php echo ($config_siteurl); ?>statics/web/img/qr-icon.png');
...
.pop-login-r .ft-img {
	background: url('<?php echo ($config_siteurl); ?>statics/web/img/login-ft.png') 0 0 no-repeat;
	width: 220px;
	height: 220px;
}

.pop-login-r .back-img {
	background: url('<?php echo ($config_siteurl); ?>statics/web/img/login-back.png') 0 0 no-repeat;
	width: 220px;
	height: 220px;
}
</style>
...
<body>
	...
	<div class="pop-ct" style="margin-top: 85px">
		<img style="position: absolute; top: -70px;" src="<?php echo ($config_siteurl); ?>statics/web/img/forget-psw-i.png"
			alt=""> <span class="forget-top-nt" style="top:-50px"> 为保障您的帐户安全， <br />
			我们将给您会员卡绑定的手机上发送验证码! <br />
		</span>
			
			<input type="hidden" name="vipcode" id="vipcode" value="<?php echo ($vipcode); ?>">
...
<script type="text/javascript"
	src="<?php echo ($config_siteurl); ?>statics/js/content_addtop.js"></script>
