...
<script type="text/javascript">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('About/index');?>">关于我们</a><span class="clr-ccc"> > </span><?php echo ($name); ?>
				</span>
			</div>
			<div class="detail-ct">
				<div class="detail-top">
					<div class="detail-l">
						<img src="<?php echo ($images_url); ?>" width="285" height="215" alt="<?php echo ($name); ?>">
					</div>
					<div class="detail-r">
						...
						<div class="about-info-list">
							...
							<div class="about-msg">
								<a href="__APP__/Jifen/index/storeid/<?php echo ($id); ?>/cityid/<?php echo ($chengshi); ?>">礼品<?php echo ($productscount); ?></a>  |  
								<a href="__APP__/Newday/index/storeid/<?php echo ($id); ?>/cityid/<?php echo ($chengshi); ?>">活动<?php echo ($activitiescount); ?></a> |  
								<a href="__APP__/Newday/daynews/storeid/<?php echo ($id); ?>/cityid/<?php echo ($chengshi); ?>">资讯<?php echo ($daynewscount); ?></a>
							</div>
							<span>门店地址：<?php echo ($address); ?></span>
							<span>服务电话：<?php echo ($phone); ?></span>
						</div>
						<div class="detail-panel">
							
							<?php if($keyname == 1 ): ?><button id="shouchangkey" class="detail-clct-btn" onclick="shouchang(<?php echo ($id); ?>,'store');"></button>
							<?php else: ?>
				...
				<div class="detail-store">
					...
					<span style="color: #333"><?php echo ($city); ?>的其他门店：</span>
					<?php if(is_array($storelistcc)): $i = 0; $__LIST__ = $storelistcc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?><span><a href="__URL__/detail/id/<?php echo ($co["id"]); ?>"><?php echo ($co["name"]); ?></a></span><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				...
				<div class="about-store-gen">
						...
						<ul class="about-store-list">
							<li>开业时间: <?php echo ($opening_time); ?></li>
							<li>地址：<?php echo ($address); ?><i class="loc"></i></li>
							<li>邮编：<?php echo ($zip_code); ?></li>
					...
					<?php if(is_array($storefloorlit)): $i = 0; $__LIST__ = $storefloorlit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="floor-num">
							<i class="floor-i"></i><?php echo ($vo["name"]); ?>：<?php echo ($vo["range"]); ?>
						</li>
						<li class="floor-store">
						<?php if(is_array($vo["Storebrand"])): $i = 0; $__LIST__ = $vo["Storebrand"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i; echo ($c["name"]); ?>,<?php endforeach; endif; else: echo "" ;endif; ?>
