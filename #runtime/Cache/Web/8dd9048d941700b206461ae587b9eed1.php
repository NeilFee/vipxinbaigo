...
<body>
	...
	<div class="bd-r"></div>
		...
		<div class="detail-main clearfix">
			...
			<div class="co-top-tab2">
				<div class="tab-section3 clearfix">
					<div class="section-btbd">
						...
						<a <?php if($act == 'a'): ?>class="cur"<?php endif; ?> href="<?php echo U("Jifen/index",array("act"=>'a'));?>">不限</a>
							<?php if(is_array($citylist)): $i = 0; $__LIST__ = $citylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($cityid == $vo['id']): ?>class="cur"<?php endif; ?>  href="<?php echo U("Jifen/index",array("cityid"=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					<div class="sec-section2">
					<?php if($storelistcc != null): ?><div class="sec-section-wd">
							<?php if(is_array($storelistcc)): $i = 0; $__LIST__ = $storelistcc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($mendian == $vo['id']): ?>class="cur"<?php endif; ?> href="__URL__/index/storeid/<?php echo ($vo['id']); ?>/cityid/<?php echo ($cityid); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div><?php endif; ?>
					</div>
					<div class="section-btbd">
						<span>选择品类：</span>
						<div class="section-wd">
						<a href="<?php echo U("Jifen/index");?>">不限</a>
							<?php if(is_array($productstypelist)): $i = 0; $__LIST__ = $productstypelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/index/typeid/<?php echo ($vo['id']); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					<div class="section-btbd-non">
						...
						<div class="section-wd">
							<a href="<?php echo U("Jifen/index");?>">不限</a>
							<?php if(is_array($productsprecelist)): $i = 0; $__LIST__ = $productsprecelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/index/productsid/<?php echo ($vo['id']); ?>"><?php echo ($vo["s_price"]); ?>-<?php echo ($vo["e_price"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
				</div>
			</div>
			<div class="total-brand">共有 <span class="tt-brnd-num"><?php echo ($count); ?></span> 个礼品</div>
			<ul class="cdt-gift-list">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U("Jifen/detail",array("id"=>$vo['id']));?>"><img src="<?php echo ($vo["img"]); ?>" alt="">
					
						<h3><?php echo ($vo["name"]); ?></h3>
						<h4><?php echo ($vo["jifen"]); ?>积分
						</h4>
						<!--<i class="credit-i"></i>-->
					</a>
			...
			<h1>< 热门兑换 ></h1>
				<?php if(is_array($productslist)): $i = 0; $__LIST__ = $productslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="rec-ct">
					<div class="rec-each">
						<a href="<?php echo U("Jifen/detail",array("id"=>$vo['id']));?>">
