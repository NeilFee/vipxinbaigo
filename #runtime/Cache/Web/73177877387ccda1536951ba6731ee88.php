...
<script type="text/javascript">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/index');?>">合作伙伴</a><span class="clr-ccc"> > </span><a href="<?php echo U('Cooperation/merchant');?>">联盟商户</a><span class="clr-ccc"> > </span><?php echo ($name); ?>
				</span>
			</div>
			<div class="detail-ct">
				<div class="detail-top">
					<div class="detail-l">
						<img src="<?php echo ($name_img); ?>" width="295" height="215" alt="">
					</div>
					<div class="detail-r">
						<h1 class="detail-title"><?php echo ($name); ?></h1>
							<div class="lmsh-detail-tt-sec-address">
								<i class="merch-loc-i"></i>
								<span class="merch-add">商户地址：<?php echo ($address); ?></span>
							</div>
							<div class="lmsh-detail-tt-sec-tel">
								<i class="merch-tel-i"></i>
								<span class="merch-tel">联系方式：<?php echo ($phone); ?></span>
							</div>

						<div class="detail-panel">
							
							<?php if($keyname == 1 ): ?><button id="shouchangkey" class="detail-clct-btn" onclick="shouchang(<?php echo ($id); ?>,'businesses');"></button>
							<?php else: ?>
