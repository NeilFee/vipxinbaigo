		...
		<div class="banner">
			...
			<div id="wowslider-container1">
           		<div class="ws_images">
					<ul>
						<li>
							<a target="_blank" href="/index.php?m=activities"><img src="<?php echo ($config_siteurl); ?>statics/web/img/newindex/top.jpg" alt="" title="" id="wows1_0" width="980" height="375" /></a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div style="float:left;height:890px;width:745px">
					<table style="width:745px;" cellpadding="0" cellspacing="0">
						<tr>
							<td style="width: 10px; height: 10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/LT.jpg') no-repeat;"></td>
							<td style="height:10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/Topline.jpg') repeat-x;"></td>
							<td style="width: 10px; height: 10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/RT.jpg') no-repeat;"></td>
						</tr>
						<tr>
							<td style="height:10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/Leftline.jpg') repeat-y;">&nbsp;</td>
							...
							<div><img src="<?php echo ($config_siteurl); ?>statics/web/img/newindex/activity_flow1.jpg" width="662" alt=""></div>
							<div style="padding:20px 0 20px 0;">
								<div style="float:left;width:6px;height:19px;background-color:#a48f65;display:inline;"></div>
							...
							<td style="height:10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/Rightline.jpg') repeat-y;">&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 10px; height: 10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/LB.jpg') no-repeat;">&nbsp;</td>
							<td style="height:10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/Bottomline.jpg') repeat-x;">&nbsp;</td>
							<td style="width: 10px; height: 10px;background:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/RB.jpg') no-repeat;">&nbsp;</td>
						</tr>
					</table>
				</div>
			<!-- 添加携程-->
				<div style="background-image:url('<?php echo ($config_siteurl); ?>statics/web/img/newindex/002.jpg');float: right;width: 210px;height: 395px;">
