		...
		<div class="detail-main clearfix">
			...
			<div class="bread-box">
				<span class="bread-pieces">
					<a href="__ROOT__/">首页</a><span class="clr-ccc"> > </span><a href="<?php echo U('Newday/index');?>">每天一点新</a><span class="clr-ccc"> > </span>最新资讯
				</span> 
			</div>
			<div class="co-top-tab2">
				<ul>
					<a href="<?php echo U("Newday/index");?>"><li>会员活动</li></a>
					<a href="<?php echo U("Newday/daynews");?>"><li class="cur">最新资讯</li></a>
				</ul>
				<div class="tab-section3 clearfix">
					<div class="section-btbd">
						<span>选择城市：</span>
						<div class="section-wd">
							<a <?php if($act == 'a'): ?>class="cur"<?php endif; ?> href="<?php echo U("Newday/daynews",array("act"=>'a'));?>">不限</a>
							<?php if(is_array($citylist)): $i = 0; $__LIST__ = $citylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($cityid == $vo['id']): ?>class="cur"<?php endif; ?> href="__URL__/daynews/cityid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					<div class="section-btbd-non" style="border:none;">
						<div class="sec-section2">
						<?php if($storelistcc != null): ?><div class="sec-section-wd">
							<?php if(is_array($storelistcc)): $i = 0; $__LIST__ = $storelistcc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a  <?php if($mendian == $vo['id']): ?>class="cur"<?php endif; ?>  href="__URL__/daynews/storeid/<?php echo ($vo["id"]); ?>/cityid/<?php echo ($cityid); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div><?php endif; ?>
					</div>
					</div>
				</div>
			...
			<div class="total-brand2">共有 <span class="tt-brnd-num"><?php echo ($count); ?></span> 条资讯</div>
			<div class="mtydx-list-ct">
				<ul>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/newsdetail/id/<?php echo ($vo["id"]); ?>">
						<li>
							<span class="lt"><?php echo ($vo["title"]); ?></span>
							<span class="rt"><span class="mtydx-zxzx-li-fbrq">发布日期：</span><span class="st-clr"><?php echo ($vo["date_time"]); ?></span></span>
						</li>
